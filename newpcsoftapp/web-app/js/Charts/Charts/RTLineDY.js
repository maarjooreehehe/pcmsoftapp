var dataString ='<chart manageResize="1" palette="2" caption="Distribution Transformer Monitor" numberPrefix="v" SNumberPrefix="mA" setAdaptiveYMin="1" setAdaptiveSYMin="1"  xAxisName="Time" showRealTimeValue="1" labelDisplay="Rotate" slantLabels="1" numDisplaySets="20" pYAxisMinValue="29" pYAxisMaxValue="36" sYAxisMinValue="55000" sYAXisMaxValue="60000" sDecimals="0" decimals="2" yaxisValueDecimals="0" sFormatNumberScale="1" canvasBottomMargin="130">\n\
   <categories>\n\
   </categories>\n\
   <dataset seriesName="Voltage" showValues="0" color="4297C3">\n\
   </dataset>\n\
   <dataset seriesName="Current" showValues="0" parentYAxis="S" color="D5A255" >\n\
   </dataset>\n\
    <dataset seriesName="Power" showValues="0" color="009900">\n\
   </dataset>\n\
   <styles>\n\
      <definition>\n\
